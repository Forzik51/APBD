...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == Emps.Max(k => k.Salary));
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = 
                Emps
                    .Select(e => new{Ename = e.Ename, Job = (string?)e.Job, Hiredate = e.HireDate})
        ...
        {                                                               
            IEnumerable<object> result = Depts
                .GroupJoin(Emps, emp => emp.Deptno, dept => dept.Deptno, (dept, emp) =>  new
                {
                    name = dept.Dname,
        ...
        /// Posortuj rezultat po nazwie departament ``.
        /// </summary>
